        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form data-action="{{ route('field.store') }}" method="POST" enctype="multipart/form-data" id="add-field-form">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="fieldtype" value="{{ $type }}">
                        ...
                        <button type="submit" class="btn btn-primary" id="add_contact">Add Record</button>
                    </form>
                </div>
            </div>
        </div>
